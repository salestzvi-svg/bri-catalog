...
const DEVELOPER_WHATSAPP = "+972505195970";
const DEVELOPER_WHATSAPP_LINK = "https://wa.me/972505195970";
    ...
    >
      <div className="mx-auto flex max-w-xs flex-col items-center gap-3">
        ...
        <a
          ...
          className="inline-flex items-center gap-1.5 text-[11px] font-medium text-emerald-700 underline-offset-2 hover:underline"
        >
          <WhatsAppIcon className="h-4 w-4 shrink-0 text-green-600" />
          <span dir="ltr">{DEVELOPER_WHATSAPP}</span>
        </a>
        <a
